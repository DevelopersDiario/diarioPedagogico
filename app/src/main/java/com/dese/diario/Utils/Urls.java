...
/** Server Online **/
 ...
 public static final String userslist =  "http://201.144.197.51:8080/diariopws/api/1.0/usuario/list";           //Funcional en server
 public static final String ufilXnombre =  "http://201.144.197.51:8080/diariopws/api/1.0/usuario/filtrousuarioXnombre"; //Funcional en server
 public static final String filtrousuarioXid =  "http://201.144.197.51:8080/diariopws/api/1.0/usuario/filtrousuarioXid";  //Funcional en server
 public static final String download =  "http://201.144.197.51:8080/diariopws/api/1.0/archivos/descargar/";         //en uso  "local"
 public static final String upload =  "http://201.144.197.51:8080/diariopws/api/1.0/usuario/upload/";
 public static final String uploadholder =  "http://201.144.197.51:8080/diariopws/api/1.0/usuario/uploadfPortada";         //en uso  "local"

 ////actualizacion de informacion de perfil
 public static final String updateestado ="http://201.144.197.51:8080/diariopws/api/1.0/usuario/updateestado";                //en uso
 public static final String updateinfPersonal ="http://201.144.197.51:8080/diariopws/api/1.0/usuario/updateinfPersonal";       //en uso
 public static final String updateinfacademica ="http://201.144.197.51:8080/diariopws/api/1.0/usuario/updateinfacademica";     //en uso
 public static final String updateinfsocial ="http://201.144.197.51:8080/diariopws/api/1.0/usuario/updateinfsocial";           //en uso
 ...
 public static final String insertpublicacion =  "http://201.144.197.51:8080/diariopws/api/1.0/publicacion/createpublicacionpadre";   //En reconstruccion
 public static final String repuplication ="http://201.144.197.51:8080/diariopws/api/1.0/publicacion/republication";
 public static final String listarrepublication="http:///201.144.197.51:8080/diariopws/api/1.0/publicacion/listrepublication";
 public static final String publicararchivo= "http://201.144.197.51:8080/diariopws/api/1.0/publicacion/publicarArchivo";
 public static final String obtenerdetallepublicacion="http://201.144.197.51:8080/diariopws/api/1.0/publicacion/listdetpublication";

 public static final String updateMyPublication="http://201.144.197.51:8080/diariopws/api/1.0/publicacion/updatepublicacionpadre";
 public static final String updateSentimientos="http://201.144.197.51:8080/diariopws/api/1.0/publicacion/updatesentimiento";
 public static final String updateEvaluacion= "http://201.144.197.51:8080/diariopws/api/1.0/publicacion/updateevaluacion";
 public static final String updateAnalisis= "http://201.144.197.51:8080/diariopws/api/1.0/publicacion/updateanalisis";
 public static final String updateConclusion= "http://201.144.197.51:8080/diariopws/api/1.0/publicacion/updateconclusion";
 public static final String updatePlan="http://201.144.197.51:8080/diariopws/api/1.0/publicacion/updateplanaccion";

 //URLs Grupo
 public static final String listgrupo ="http://201.144.197.51:8080/diariopws/api/1.0/grupo/list";            //Funcional en server
 public static final String listgpoxid ="http://201.144.197.51:8080/diariopws/api/1.0/grupo/listgpoxid";     //Funcional en server " requiere parametro idgrupo"
 public static final String listuserxgpo="http://201.144.197.51:8080/diariopws/api/1.0/grupodetalle/listusersgpo";
 public static final String creategpo ="http://201.144.197.51:8080/diariopws/api/1.0/grupo/create";    //correcion
 public static final String listargpoxpublicacion="http://201.144.197.51:8080/diariopws/api/1.0/grupo/listgpoXppadre";
